...
class BatchManager:
    ...
    def __init__(self, max_workers: int = 50, checkpoint_file: str | Path | None = None, save_interval: int = 10):
    ...
    async def process_batch(
        self, items: Iterable[Any], processor: Callable[[Any], Coroutine[Any, Any, Any]], desc: str = "Processing"
    ) -> list[dict[str, Any]]:
        """
        ...
        items_to_process: list[tuple[int, Any]] = []
...
class RequestManager(BatchManager):
    ...
    async def run_batch(self, coros: list[Coroutine[Any, Any, Any]] | None = None) -> list[Any]:
        ...
        async def _wrapper(coro: Coroutine[Any, Any, Any]) -> Any:
            return await coro
