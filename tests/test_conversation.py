...
from llm_client.providers.types import Message, Role, ToolCall
...
class TestConversationBasics:
    ...
    def test_add_assistant_with_tools(self):
        ...
        tool_calls = [
            ToolCall(id="call_1", name="weather", arguments='{"city": "NYC"}')
        ]
...
class TestConversationSerialization:
    ...
    def test_preserves_tool_calls_on_serialization(self):
        ...
        tool_calls = [
            ToolCall(id="call_abc", name="get_weather", arguments='{"city": "LA"}')
        ]
